...
/* DarkChat Markdown renderer. A pure, platform-independent pass that turns
   ...
   strikethrough, equal-length inline backtick spans and backtick/tilde fenced
   code, flat lists (including unordered [ ]/[xX] task markers), HTTP(S)
   links and blockquotes. Unsupported or
